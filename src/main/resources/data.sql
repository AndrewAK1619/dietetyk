...
INSERT INTO physical_activities(physical_activity_id, degree_of_physical_activity) VALUES
  (1, '1 - Pacjent leżący w łóżku'),
  (2, '2 - Aktywność fizyczna niska'),
  (3, '3 - Aktywność fizyczna umiarkowana'),
  (4, '4 - Aktywny tryb życia'),
  (5, '5 - Bardzo aktywny tryb życia'),
  (6, '6 - Wyczynowe uprawianie sportu');

INSERT INTO patients(patient_id, first_name, last_name, email, sex, age, body_weight, height, physical_activity_id, chronic_diseases_ailments_and_medicines_used, allergies_and_food_intolerances, supplements_used) VALUES
  (1, 'Emily', 'Evans', 'emilyEvans@example.com', 'Female', 26, 56.5, 172, 4, 'Brak', 'Brak', 'Brak');
